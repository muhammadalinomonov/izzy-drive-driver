...
import 'package:taxi_app/src/features/profile/data/model/work_time_model.dart';
...
class WorkTimeEntity extends Equatable {
  ...
  const WorkTimeEntity({this.days = 0, this.hours = 0, this.minutes = 0});
...
class WorkTimeEntityConverter implements JsonConverter<WorkTimeEntity, Map<String, dynamic>> {
  ...
  Map<String, dynamic> toJson(WorkTimeEntity object) {
    return {'days': object.days, 'hours': object.hours, 'minutes': object.minutes};
  }
}
