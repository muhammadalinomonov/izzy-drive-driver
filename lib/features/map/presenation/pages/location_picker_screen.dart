...
import 'package:taxi_app/features/map/data/model/nearby_masters_response.dart';
import 'package:taxi_app/features/map/data/model/search_locations_response.dart';
  ...
  Future<geolocator.Position?> _readGpsPosition() async {
    try {
      ...
      return await geolocator.Geolocator.getCurrentPosition(
        locationSettings: const geolocator.LocationSettings(accuracy: geolocator.LocationAccuracy.bestForNavigation),
      );
    } catch (_) {
      return null;
    }
