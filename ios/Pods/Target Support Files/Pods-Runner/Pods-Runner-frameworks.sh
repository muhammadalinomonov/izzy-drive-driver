...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/hl_image_picker_ios/hl_image_picker_ios.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/mapbox_maps_flutter/mapbox_maps_flutter.framework"
