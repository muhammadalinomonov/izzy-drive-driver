...
class GetOrdersUseCase implements UseCase<GenericPagination<OrderEntity>, String?> {
  final OrdersRepository repository;

  GetOrdersUseCase({required this.repository});

  @override
  Future<Either<Failure, GenericPagination<OrderEntity>>> call(String? params) async {
    return await repository.getOrders(next: params);
  }
}
