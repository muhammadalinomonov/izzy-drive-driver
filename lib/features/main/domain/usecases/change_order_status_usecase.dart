...
class ChangeOrderStatusUseCase implements UseCase<void, ({int orderId, String status})> {
  final OrdersRepository repository;

  ChangeOrderStatusUseCase({required this.repository});

  @override
  Future<Either<Failure, void>> call(({int orderId, String status}) params) async {
